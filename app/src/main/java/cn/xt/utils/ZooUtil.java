...
public class ZooUtil {
    ...
    public static void initZooData(int width, int height, Resources res) {
        ...
        ali.setBitmap(BitmapFactory.decodeResource(res, R.mipmap.keypool1));
        xj.setId(2);
        xj.setSize(width, height);
        xj.setBitmap(BitmapFactory.decodeResource(res, R.mipmap.keypool2));
        gx.setId(3);
        gx.setSize(width, height);
        gx.setBitmap(BitmapFactory.decodeResource(res, R.mipmap.keypool3));
        qw.setId(4);
        qw.setSize(width, height);
        qw.setBitmap(BitmapFactory.decodeResource(res, R.mipmap.keypool4));
        hm.setId(5);
        hm.setSize(width, height);
        hm.setBitmap(BitmapFactory.decodeResource(res, R.mipmap.keypool5));
